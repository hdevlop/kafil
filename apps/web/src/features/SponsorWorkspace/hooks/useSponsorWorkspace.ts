...
import { changeSponsorPlan, createSponsorPlan, listSponsorContributions, listSponsorFamilyCatalog, listSponsorPlans, listSponsorSupport, selectSponsorFamily, submitSponsorContribution } from "@/services/sponsorWorkspaceApi";
import type { SponsorListQuery } from "../types";
const keys = { all: ["sponsor-workspace"] as const, catalog: ["sponsor-workspace", "catalog"] as const, support: ["sponsor-workspace", "support"] as const, plans: (q: SponsorListQuery) => ["sponsor-workspace", "plans", q] as const, contributions: (q: SponsorListQuery) => ["sponsor-workspace", "contributions", q] as const };
