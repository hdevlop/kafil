...
export interface SponsorContribution { id: string; supportAssignmentId: string; amountMinor: number; currency: string; paymentMethod: string; externalReference: string | null; status: string; submittedAt: string; paidAt: string | null; expiresAt: string | null; expiredAt: string | null; }
...
export interface SponsorSupportedOrder { id: string; orderNumber: string; status: string; totalMinor: number; actualTotalMinor: number | null; merchantName: string | null; purchasedAt: string | null; receiptRecorded: boolean; deliveryProofRecorded: boolean; currency: string; placedAt: string; approvedAt: string | null; preparationStartedAt: string | null; deliveryStartedAt: string | null; deliveredAt: string | null; items: Array<{ productName: string; sku: string; quantity: number; unitPriceMinor: number; lineTotalMinor: number }>; }
