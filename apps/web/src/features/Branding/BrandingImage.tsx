...
const FACTORY_FALLBACKS: Record<string, string> = {
  sidebarLogoExpanded: "/logoExpanded.png",
  sidebarLogoCollapsed: "/logoExpanded.png",
  authLogo: "/logoExpanded.png",
  authHeroImage: "/HeroA.png",
};
...
export function BrandingImage(props: BrandingImageProps) {
  const { slot, src, alt, className, priority } = props;
  ...
  const isCustomBrandingAsset = resolved.startsWith(
    "/api/branding/assets/serve/",
  );
  ...
  if (props.fill) {
    const imageProps: ImageProps = {
      ...
      priority,
      unoptimized: isCustomBrandingAsset,
