      ...
      <NGrid cols={1} xlCols={12}>
        ...
        <NGridItem span={1} xlSpan={3}>
          <SupportBudgetCard
            ...
            footer={
              <Link
                className="block w-full rounded-lg border border-dashed border-border/70 px-4 py-2.5 text-center text-sm font-medium text-muted-foreground hover:bg-muted/60 hover:text-foreground"
                href="/sponsor/budgets"
              >
                {tString("dashboard.sponsor.viewAllBudgets")}
              </Link>
            }
          />
        </NGridItem>
        <NGridItem span={1} xlSpan={4}>
          <ContributionOverviewCard
            ...
            title={tString("dashboard.sponsor.contributionOverview")}
